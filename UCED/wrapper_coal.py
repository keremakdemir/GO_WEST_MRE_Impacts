...
df_losses = pd.read_csv('Inputs/west_{}_lostcap.csv'.format(my_cwd[-7:-3]),header=0,index_col=0)
...
for day in range(1,days+1):
    ...
    #load Wave time series data
        for i in K:
            ...
            instance2.HorizonWave[z,i] = instance.SimWave[z,(day-1)*24+i]
   ...
   #NEED TO ADD MUST RUN GENERATION OUTAGES     
    ...
    for z in instance.lines:
        for i in K:  
            ...
            instance2.HorizonLineLimit[z,i] = max(0, instance.HorizonLineLimit[z,i].value - df_line_outages.loc[(day-1)*24+i-1,z])
